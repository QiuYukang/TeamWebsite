...
<form id="search_form" method="get" action="">
    ...
    <div class="row">
        ...
        <div class="columns">
            ...
            <div class="clearfix"></div>
            <input id="category" name="category" type="text" onkeydown='if(event.keyCode==13){search_btn.click()}' style="float: left; width:220px;" placeholder="输入类别或在右侧选择" value="<?php echo isset($now_criteria['category']) ? $now_criteria['category'] : ''?>">
        ...
        <div class="columns" style="width: 324px">
            ...
            <input id="index_number" name="index_number" type="text" onkeydown='if(event.keyCode==13){search_btn.click()}' value="<?php echo isset($now_criteria['index_number']) ? $now_criteria['index_number'] : ''?>">
        </div>
        <div class="clearfix"></div>
    </div>
