...
if((isset($user->is_admin) && $user->is_admin) ||
    ...
    echo CHtml::link('管理论文', 'index.php?r=paper/admin', array('class' => 'btn btn-primary'));
}
    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <ul class="pagination">
                ...
                <?php  if($page!=1) echo '<li><a href="index.php?r=paper/index&page=1">首页</a></li>'; else echo '<li><a href="index.php?r=paper/index&page=1">已是首页</a></li>';?>
                <?php if($page!=1) echo '<li><a href=index.php?r=paper/index&page='.($page-1).'>&laquo;</a></li>' ?>
