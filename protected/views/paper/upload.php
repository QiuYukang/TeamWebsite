...
<div class="cam-content cam-recessed-content">
    <div class="cam-wrap clearfix">
        <div class="index-content">
            ...
            <div class="create-upload">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div style="margin-top: 10px">
                        ...
                        <input type="button" value="下载标准导入格式文件" class="btn btn-default" style="float: right" onclick="location='index.php?r=paper/downloadformat'"/>
                    </div>
            ...
            <p>4. 为了保证项目、人员、论文间的链接关系，在数据库为空的时候应该按照导入人员->科研项目->论文/专利/专著/软件著作权的顺序导入</p>
