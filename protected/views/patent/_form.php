...
//                'enableAjaxValidation'=>false,
        ...
        <div class="row">
            <div class="medium-6 columns end" id="number">
                <?php echo $form->labelEx($model,'number'); ?>
                <?php echo $form->textField($model,'number',array('size'=>60,'maxlength'=>255)); ?>
                <?php echo $form->error($model,'number'); ?>
            </div>
            <div class="medium-2 columns end" id="status">
        ...
        <div class="row">
            ...
            <div class="medium-3 columns" id="app_date">
                <?php echo $form->labelEx($model,'app_date'); ?>
                <?php echo $form->textField($model,'app_date',array('placeholder'=>'日期格式: yyyy-mm-dd')); ?>
                <?php echo $form->error($model,'app_date'); ?>
            </div>
            <div class="medium-3 columns end" id="auth_date">
                <?php echo $form->labelEx($model,'auth_date'); ?>
                <?php echo $form->textField($model,'auth_date',array('placeholder'=>'日期格式: yyyy-mm-dd')); ?>
        ...
        <div class="row" id="abstract">
            <div class="medium-12 columns end">
                ...
                <?php echo $form->textArea($model,'abstract',array('size'=>120,'maxlength'=>2048)); ?>
