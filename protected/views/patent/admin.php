...
if(isset($user->is_admin) && $user->is_admin || isset($user->is_manager) && $user->is_manager) {
    echo '&nbsp;&nbsp;';
    echo CHtml::link('添加专利', 'index.php?r=patent/create', array('class' => 'btn btn-primary'));
}
if(isset($user->is_admin) && $user->is_admin) {
    echo '&nbsp;&nbsp;';
    echo CHtml::link('清空专利', 'index.php?r=patent/clear', array('class' => 'btn btn-primary', 'onclick' => 'return clear_firm()'));
}

if(isset($user->is_admin) && $user->is_admin || isset($user->is_manager) && $user->is_manager) {
    echo '&nbsp;&nbsp;';
    echo CHtml::link('导入专利数据表', 'index.php?r=patent/upload', array('class' => 'btn btn-primary'));
    echo '&nbsp;&nbsp;';
    echo CHtml::link('导入专利文件', 'index.php?r=patent/uploadfile', array('class' => 'btn btn-primary'));
}
?>
