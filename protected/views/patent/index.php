...
$this->pageTitle=Yii::app()->name . ' - 专利';
//面包屑
...
<div class="cam-page-header">
    <div class="cam-wrap clearfix cam-local-navigation">
        <ul class="cam-unstyled-list cam-current">
            ...
            <li class="cam-current-page"><a href="#" class="active-trail">专利</a></li>
...
<div class="cam-content cam-recessed-content">
    <div class="cam-wrap clearfix">
        ...
        if((isset($user->is_admin) && $user->is_admin) ||
            ...
            <ul class="index-list">
                <li><a href="index.php?r=patent/admin">进入管理页面</a></li>
        ...
        <div class="index-content">
            <?php
            if($data_count == 0) {
                echo "<p>团队数据库中暂时没有记载专利数据。</p>";
                echo '<img style="margin: 10px 0 20px 0;" src="'.Yii::app()->request->baseUrl.'/images/no_data.png"/>';
            } else {
                echo "<p>截止目前，团队数据库中共记录了 $data_count 篇专利，当前页显示第 ".($offset + 1)." - ".min( $offset + $page_size, $data_count)." 篇，共 $page_count 页。</p>";
                ?>
            <?php
            //用于计算页码按钮上的显示
            if($page_count >= 5) {
