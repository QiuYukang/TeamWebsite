...
if((isset($user->is_admin) && $user->is_admin) ||
    ...
    echo CHtml::link('管理科研项目', 'index.php?r=project/admin', array('class' => 'btn btn-primary'));
}
    ...
    <div class="row">
        ...
        <div class="col-xs-4">
            <ul class="pagination">
                ...
                <?php  if($page!=1) echo '<li><a href="index.php?r=project/index&page=1">首页</a></li>'; else echo '<li><a href="index.php?r=project/index&page=1">已是首页</a></li>';?>
    <?php if($page!=1) echo '<li><a href=index.php?r=project/index&page='.($page-1).'>&laquo;</a></li>' ?>
