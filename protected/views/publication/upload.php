...
$this->pageTitle=Yii::app()->name . ' - 导入著作';
//面包屑
...
<div class="cam-content cam-recessed-content">
    <div class="cam-wrap clearfix">
        <div class="index-content">
            ...
            <div class="create-upload">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div style="margin-top: 10px">
                        ...
                        <input type="button" value="下载标准导入格式文件" class="btn btn-default" style="float: right" onclick="location='index.php?r=publication/downloadformat'"/>
                    </div>
            ...
            <p>3. 为保证链接关系，导入的文件中同一人员或著作的人员名、著作名等应该在多个文件中保持完全一致，包括标点符号</p>
