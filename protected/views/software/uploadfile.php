...
$this->pageTitle=Yii::app()->name . ' - 导入软件著作权文件';
//面包屑
        ...
        <div class="cam-column">
            <div class="cam-content-container">
                <h1 class="cam-sub-title">
                    导入软件著作权文件 Upload software copyright file
                </h1>
            </div>
        </div>
    </div>
...
<div class="cam-content cam-recessed-content">
    <div class="cam-wrap clearfix">
        <div class="index-content">
            ...
            <br/>
            <p>小提示：</p>
            <p>1. 批量导入文件适合为一批没有上传文件的软件著作权（批量导入的软件著作权）一次性导入文件，若单个添加文件可在添加或编辑页面进行</p>
            <p>2. 批量导入文件时文件名（包括后缀）一定要与表格中的软件著作权文件名保持完全一致，包括标点符号</p>
